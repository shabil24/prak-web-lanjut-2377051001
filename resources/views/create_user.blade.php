...
<body class="bg-gradient-to-r from-gray-300 to-gray-500 flex items-center justify-center min-h-screen"> <!-- Mengubah latar belakang menjadi gradien -->
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <form action="{{ route('user.store') }}" method="POST" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-gray-500 text-white font-semibold py-2 rounded-lg hover:bg-gray-600 transition">Submit</button> <!-- Mengubah warna tombol menjadi abu-abu -->
        </form>
    </div> 
</body>
</html>